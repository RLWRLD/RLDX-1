#!/bin/bash
#SBATCH --job-name="Pretrain RLDX-1 (video-only) on MixV4 dataset"
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=1
#SBATCH --gpus-per-node=8
#SBATCH --partition=${SBATCH_PARTITION:-gpu}
#SBATCH --output=slurm_out/%j-rldx1_pt_mixv4_bsz1024_100k.out
#SBATCH --error=slurm_out/%j-rldx1_pt_mixv4_bsz1024_100k.err
...
CKPT_NAME="rldx1_pt_mixv4_bsz1024_100k"
RUN_NAME="rldx1_pt_mixv4_bsz1024_100k"
# =========================================
