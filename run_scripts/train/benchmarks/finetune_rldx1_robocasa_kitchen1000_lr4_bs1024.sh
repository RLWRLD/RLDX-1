...
CKPT_NAME="rldx1_ft_robocasa1000_bsz1024_lr4e4_60k"
RUN_NAME="rldx1_ft_robocasa1000_bsz1024_lr4e4_60k"
# =========================================

NUM_GPUS=8
BASE_DIR="$(git -C "$(dirname "$0")" rev-parse --show-toplevel)"
DATA_DIR="TBD_DATA_DIR"  # TODO(release): path to LeRobot dataset root
