#!/bin/bash
#SBATCH --job-name="Finetune RLDX-1 (motion + memory + physics) on ALLEX dataset"
#SBATCH --nodes=1
#SBATCH --gpus=8
#SBATCH --partition=${SBATCH_PARTITION:-gpu}
#SBATCH --output=slurm_out/%j-rldx1_midtrain_allex.out
#SBATCH --error=slurm_out/%j-rldx1_midtrain_allex.err
...
CKPT_NAME="rldx1_midtrain_allex"
RUN_NAME="rldx1_midtrain_allex"
# =========================================
...
# 64 GPU, bs2048 -> 32
# 64 GPU, bs1024 -> 16 (non-available)
# 64 GPU, bs512 -> 8 (available)