...
robocasa_panda_omron = {  # TY: folowing https://huggingface.co/nvidia/GR00T-N1.6-3B/blob/main/processor_config.json
...
register_modality_config(robocasa_panda_omron, EmbodimentTag.GENERAL_EMBODIMENT)
