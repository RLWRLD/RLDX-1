...
for file in Path(__file__).parent.glob("*.py"):
    ...
    try:
        ...
        _print(f"Error importing module rldx.configs.model.{file.stem}: {e}")


def create_model_union_type():
    logging.debug("MODEL_CONFIG_TYPES=%r", MODEL_CONFIG_TYPES)
...
def get_model_config(shortname: str):
    return MODEL_CONFIG_TYPES[shortname]
